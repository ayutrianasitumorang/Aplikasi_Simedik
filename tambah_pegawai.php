...
<form action="simpan_pegawai.php" method="post">
        ...
        <tr>
                <td>ID Pegawai</td>
                <td><input name="id" type="textbox" placeholder="ID Pegawai" class="form-control"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td><input name="Nama" type="textbox" placeholder="Nama Pegawai" class="form-control"></td>
            </tr>
            <tr>
              <td>Username</td>
            ...
            <tr>
                <td>Profesi</td>
                <td><input name="Profesi" type="textbox" placeholder="Profesi" class="form-control"></td>
            </tr>
            <tr>
                <td></td>
                <td>
                <a href="data_pegawai.php" class="btn btn-danger">
                    Kembali</a>
