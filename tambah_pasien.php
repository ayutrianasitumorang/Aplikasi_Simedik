...
<h4>Formulir Data Pasien</h4>
<form action="simpan_pasien.php" method="post">
        <table class="table table-bordered">
        <tr>
                <td>Nomor Rekam Medik</td>
                <td><input name="id_pasien" type="textbox" placeholder="ID Pasien" class="form-control"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td><input name="nama" type="textbox" placeholder="Nama Lengkap Pasien" class="form-control"></td>
            </tr>
            <tr>
              <td>Tanggal Lahir
              </td>
              <td><input name="tgl_lhr" type="date" placeholder="Tanggal Lahir" class="form-control"></td>
          </tr>
          <tr>
                <td>Jenis_kelamin</td>
            ...
            <tr>
              <td>Nomor_HP</td>
              <td><input name="hp" type="textbox" placeholder="Nomor Handphone" class="form-control"></td>
          </tr>
          <tr>
              <td>Nomor BPJS</td>
              <td><input name="no_bpjs" type="textbox" placeholder="Nomor BPJS" class="form-control"></td>
          </tr>
          <tr>
              <td>Alergi</td>
              <td><input name="alergi" type="textbox" placeholder="Alergi" class="form-control"></td>
          </tr>
            <tr>
                <td></td>
                <td>
                <a href="data_pasien.php" class="btn btn-danger">
                    Kembali</a>
