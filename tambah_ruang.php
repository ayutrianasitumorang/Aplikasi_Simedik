...
<h4>Formulir Tambah Ruang</h4>
<form action="simpan_ruang.php" method="post">
        <table class="table table-bordered">
        <tr>
                <td>ID Ruang</td>
                <td><input name="id" type="textbox" placeholder="id" class="form-control"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td><input name="nama_ruang" type="textbox" placeholder="Nama Ruangan" class="form-control"></td>
            </tr>
            <tr>
              <td>Keterangan
              </td>
              <td><input name="keterangan" type="texbox" placeholder="Keterangan" class="form-control"></td>
          </tr>
            <tr>
                <td></td>
                <td>
                <a href="data_ruang.php" class="btn btn-danger">
                    Kembali</a>
