    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="card-header py-3">
            ...
            <button type="button" class="btn btn-success btn-sm">Tambah Pegawai</button> 
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                include 'koneksi.php';
                $i = 1;
                $rm = mysqli_query($koneksi, "SELECT * FROM pegawai");
                ...
                ?>
                    <tr>
                      ...
                      <th>
                      <a href ="edit_pegawai.php?id=<?php echo $row['id'];?>" title="Edit" class="btn btn-circle btn-warning btn-sm">
                      <i class="fas fa-pen"></i></a>
                      <a href="delete_pegawai.php?id=<?php echo $row['id'];?>"  title="Hapus Data"   class="btn btn-circle btn-danger btn-sm">
