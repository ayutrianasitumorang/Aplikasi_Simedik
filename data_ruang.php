        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 " <span style="color: black";>Daftar Ruang</h1></span>
                    <h10>Data Ruang pada Medical Clinic.</h10>
          ...
          <div class="card-header py-3">
            ...
            <button type="button" class="btn btn-success btn-sm">Tambah Ruang</button> 
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <td>
                      <a href ="edit_ruang.php?id=<?php echo $row['id'];?>" title="Edit" class="btn btn-circle btn-warning btn-sm">
                      <i class="fas fa-pen"></i></a>
                      <a href="delete_ruang.php?id=<?php echo $row['id'];?>"  title="Hapus Data"   class="btn btn-circle btn-danger btn-sm">
