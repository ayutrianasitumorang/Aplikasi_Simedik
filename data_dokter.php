        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 " <span style="color: black";>Daftar Dokter</h1></span>
                    <h10>Data Dokter pada Medical Clinic.</h10>
          ...
          <div class="card-header py-3">
            ...
            <button type="button" class="btn btn-success btn-sm">Tambah Dokter</button> 
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <td><?php echo $row['tipe_dr'];?></td>
                      <th>
                      <a href ="edit_dokter.php?id_dokter=<?php echo $row['id_dokter'];?>" title="Edit" class="btn btn-circle btn-warning btn-sm">
                      <i class="fas fa-pen"></i></a>
                      <a href="delete_dokter.php?id_dokter=<?php echo $row['id_dokter'];?>"  title="Hapus Data"   class="btn btn-circle btn-danger btn-sm">
