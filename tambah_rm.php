...
<h4>Formulir Tambah Rekam Medis</h4>
<form action="simpan_rm.php" method="post">
        <table class="table table-bordered">
        <tr>
                <td>Nomor Rekam Medik</td>
                <td><input name="id_pasien" type="textbox" placeholder="id" class="form-control"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td><input name="nama_pasien" type="textbox" placeholder="Nama Pasien" class="form-control"></td>
            </tr>
            <tr>
              <td>Anamnesis</td>
              <td><input name="anamnesis" type="texbox" placeholder="anamnesis" class="form-control"></td>
          </tr>
          <td>Diagnosa</td>
              <td><input name="diagnosis" type="texbox" placeholder="diagnosis" class="form-control"></td>
          </tr> 
          <td>Resep</td>
              <td><input name="resep" type="texbox" placeholder="resep" class="form-control"></td>
          </tr>
          <td>Jumlah</td>
              <td><input name="jumlah" type="texbox" placeholder="jumlah" class="form-control"></td>
          </tr>
          <td>Aturan</td>
              <td><input name="aturan" type="texbox" placeholder="aturan" class="form-control"></td>
          </tr>
          <td>Dokter</td>
              <td><input name="dokter" type="texbox" placeholder="dokter" class="form-control"></td>
          </tr>
            <tr>
                <td></td>
                <td>
                <a href="data_rm.php" class="btn btn-danger">
                    Kembali</a>
