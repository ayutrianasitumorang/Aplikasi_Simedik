            ...
            <li class="nav-item">
                ...
                <div id="collapseRuang" class="collapse" aria-labelledby="headingRuang" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tambah_ruang">Tambah Ruang</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 " <span style="color: black";>Daftar Pasien</h1></span>
                    <h10>Data Pasien pada Medical Clinic.</h10>
          ...
          <div class="card-header py-3">
            ...
            <a href="tambah_rm.php"> 
            <button type="button" class="btn btn-success btn-sm">Tambah Rekam Medis</button> 
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <th>
                      <a href ="edit_rm.php?id_pasien=<?php echo $row['id_pasien'];?>" title="Edit" class="btn btn-circle btn-warning btn-sm">
                      <i class="fas fa-pen"></i></a>
                      <a href="delete_rm.php?id_pasien=<?php echo $row['id_pasien'];?>"  title="Hapus Data"   class="btn btn-circle btn-danger btn-sm">
