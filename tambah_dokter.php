...
<h4>Formulir Data Dokter</h4>
<form action="simpan_dokter.php" method="post">
        <table class="table table-bordered">
        <tr>
                <td>ID Dokter</td>
                <td><input name="id_dokter" type="textbox" placeholder="ID Dokter" class="form-control"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td><input name="nm_dokter" type="textbox" placeholder="Nama Lengkap Dokter" class="form-control"></td>
            </tr>
            <tr>
              <td>Tanggal Lahir
              </td>
          ...
          <tr>
            ...
            <tr>
              <td>Nomor HP</td>
              <td><input name="telepon" type="textbox" placeholder="Nomor Handphone" class="form-control"></td>
          </tr>
          <tr>
                <td>Agama</td>
          ...
          <tr>
              <td>Spesialis</td>
              <td><input name="tipe_dr" type="textbox" placeholder="Spesialis Dokter" class="form-control"></td>
          </tr>
            <tr>
                <td></td>
                <td>
                <a href="data_dokter.php" class="btn btn-danger">
                    Kembali</a>
