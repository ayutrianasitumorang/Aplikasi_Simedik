    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="card-header py-3">
            ...
            <button type="button" class="btn btn-success btn-sm">Tambah Pasien</button> 
            </div>
        <div class="card-body">
              <div class="table-responsive">
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <th>
                      <a href ="edit_pasien.php?id_pasien=<?php echo $row['id_pasien'];?>" title="Edit" class="btn btn-circle btn-warning btn-sm">
                      <i class="fas fa-pen"></i></a>
                      <a href="delete_pasien.php?id_pasien=<?php echo $row['id_pasien'];?>"  title="Hapus Data"   class="btn btn-circle btn-danger btn-sm">
