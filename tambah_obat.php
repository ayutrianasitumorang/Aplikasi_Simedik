...
<h4>Formulir Data Obat</h4>
<form action="simpan_obat.php" method="post">
        <table class="table table-bordered">
        <tr>
                <td>ID Obat</td>
                <td><input name="id" type="textbox" placeholder="ID Obat" class="form-control"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td><input name="nama_obat" type="textbox" placeholder="Nama Obat" class="form-control"></td>
            </tr>
            <tr>
              <td>Sediaan</td>
              <td><input name="sediaan" type="date" placeholder="Persediaan" class="form-control"></td>
          </tr>
            <tr>
                <td>Dosis</td>
                <td><input name="dosis" type="textbox" placeholder="Dosis" class="form-control"></td>
            </tr>
            <tr>
              <td>Stok</td>
              <td><input name="stok" type="textbox" placeholder="Stok" class="form-control"></td>
          </tr>
          <tr>
              <td>Harga</td>
              <td><input name="harga" type="textbox" placeholder="Harga" class="form-control"></td>
          </tr>
            <tr>
                <td></td>
                <td>
                <a href="data_obat.php" class="btn btn-danger">
                    Kembali</a>
