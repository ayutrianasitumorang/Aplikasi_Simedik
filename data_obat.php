            ...
            <li class="nav-item">
                ...
                <div id="collapseObat" class="collapse" aria-labelledby="headingObat" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tambah_obat">Tambah Obat</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 " <span style="color: black";>Daftar Obat</h1></span>
                    <h10>Data Obat pada Medical Clinic.</h10>
          ...
          <div class="card shadow mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Data Obat</h6>
              ...
              <button type="button" class="btn btn-success btn-sm">Tambah Obat</button>
            </div>
</div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <th>
                      <a href ="edit_obat.php?id=<?php echo $row['id'];?>" title="Edit" class="btn btn-circle btn-warning btn-sm">
                      <i class="fas fa-pen"></i></a>
                      <a href="delete_obat.php?id=<?php echo $row['id'];?>"  title="Hapus Data"   class="btn btn-circle btn-danger btn-sm">
